  ...
  return (
    <div className="flex items-center justify-center h-screen text-primary font-primary w-100">
      <div className="flex justify-center flex-col w-full p-6 text-center h-4/5 ">
        ...
        <Link
          href="/signup/email"
          className="flex items-center justify-center w-full py-3 mx-auto mt-8 mb-4 text-white border rounded-full sm:w-4/5 bg-dark"
        >
        ...
        <button
          ...
          className="flex  w-full sm:w-4/5 gap-4 justify-center px-6 py-3 mt-4 mb-8 mx-auto text-center text-gray-700 bg-white border border-gray-700 transition ease-in-out rounded-full font-medium"
        >
